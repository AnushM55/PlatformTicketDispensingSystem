...
public class Welcome {
    Welcome(){
       ...
       // welcomePanel.setBackground(new Color(173, 216, 230)); // Match background color of frame
        ...
        JLabel styledTextLabel = new JLabel("<html><center>Click on <font color='blue'>\"CONTINUE\"</font> to proceed</center></html>");
